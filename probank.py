...
ACCOUNTS.append({'accno': 1001,'name': 'Pranav', 'bal': 1000.00, 'add': 'Thane'})
ACCOUNTS.append({'accno': 1002,'name': 'Akash', 'bal': 2500.00, 'add': 'Mulund'})
ACCOUNTS.append({'accno': 1003,'name': 'Tejasvi', 'bal': 5000.00, 'add': 'Bhayandar'})
ACCOUNTS.append({'accno': 1004,'name': 'Vaishnavi', 'bal': 7500.00, 'add': 'Ghatkopar'})
